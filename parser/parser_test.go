...
var testTable = []parserTest{
	...
	{"list with numeric variable true", "[10 20 Number(var1)] CONTAINS 1", `{"var1":1}`, expectTrue},
	{"list with numeric variable false", "[10 20 Number(var1)] CONTAINS 2", `{"var1":1}`, expectFalse},
	{"list with string variable true", "[10 20 Number(var1)] CONTAINS 1", `{"var1":"1"}`, expectTrue},
	{"list with string variable false", "[10 20 Number(var1)] CONTAINS 2", `{"var1":"1"}`, expectFalse},
	{"list with numeric variable error 1", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('1')", `{"var1":1}`, expectError},
	{"list with numeric variable error 2", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('2')", `{"var1":1}`, expectError},
	{"list with string variable error 1", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('1')", `{"var1":"1"}`, expectError},
	{"list with string variable error 2", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('2')", `{"var1":"1"}`, expectError},
