...
var testTable = []parserTest{
	...
	{"list with numeric variable true", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('1')", `{"var1":1}`, expectTrue},
	{"list with numeric variable false", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('2')", `{"var1":1}`, expectFalse},
	{"list with string variable true", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('1')", `{"var1":"1"}`, expectTrue},
	{"list with string variable false", "['beta' 'alpha' 'has_reward_program' Number(var1)] CONTAINS Number('2')", `{"var1":"1"}`, expectFalse},
